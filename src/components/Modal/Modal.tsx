...
export default function Modal({
  ...
  return (
    <div className="overlay z-50">
      <div className="w-[260px] h-[200px] md:w-[400px] md:h-[250px] px-6 py-8 md:p-10 bg-white flex flex-col justify-between items-center fixed z-50 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
