...
export default function DeletePopup({ isOpen, onUndo }: DeletePopupProps) {
  return (
    ...
    >
      <div className="w-full h-[100px] flex flex-col gap-5 sm:flex-row justify-between items-center bg-custombg px-8 sm:px-16 py-5 shadow-[-4px_-4px_10px_rgba(0,0,0,0.1)]">
